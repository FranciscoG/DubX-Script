...
if (!hello_run) {
    hello_run = true;
    var hello = {
        our_version : '03.00.85 - Twitch Emotes/Custom Emojis',
        gitRoot : 'https://rawgit.com/FranciscoG/DubX-Script/dev',
        modules : {},

        /*********************************************************************
         * Handles loading the modules
         */
        ...
        /*********************************************************************
         * Creates the "standard" section of the menu based on the modules
         * loaded.  This should be run after all addModules are complete
         */
        ...
        /*********************************************************************
         * Some utilities and non-module specific functions 
         */
        slide: function() {
        ...
        /*********************************************************************
         * This is the DubX menu
         * option_menu = {string}   generated by calling makeOptionMenu
         */
        //Ref 2.2: Initialize
        ...
        /*********************************************************************
         * Run this function at the very end
         */
        init : function(){
    ...
    /***************************************************************************
     * Now we add the modules that are dynamically added to the 'standard' 
    ...
    /**************************************************************************
     * Run all the things that only need to run once on load
     */
    hello.init();
