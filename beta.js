...
if (!hello_run && Dubtrack.session.id) {
    ...
    var hello = {
        ...
        drawMenuItem: function(menuFunc, menuClass, menuTitle){
            return '<li onclick="hello.'+menuFunc+'();" class="for_content_li for_content_feature '+menuClass+'">',
                ...
                '<div class="for_content" style="display:none;">',
                    ...
                    '<ul class="for_content_ul">',
                        ...
                        '<ul class="draw_general">',
                            hello.drawMenuItem('snow', 'snow', 'Snow'),
                            hello.drawMenuItem('autovote', 'autovote', 'Autovote'),
                            hello.drawMenuItem('autovote', 'autovote', 'Autovote'),
                            ...
                            '</li>',
                            hello.drawMenuItem('optionTwitchEmotes', 'twitch_emotes', 'Emotes'),
                            hello.drawMenuItem('optionEmojiPreview', 'emoji_preview', 'Autocomplete Emoji'),
                            hello.drawMenuItem('optionMentions', 'autocomplete_mentions', 'Autocomplete Mentions'),
                            ...
                            '</li>',
                            hello.drawMenuItem('mentionNotifications', 'mention_notifications', 'Notification on Mentions'),
                        '</ul>',
                        '<li class="for_content_li" onclick="hello.drawSection(this)">',
                            '<p class="for_content_c">',
                                'User Interface',
